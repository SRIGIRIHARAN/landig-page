    ...
    <div className='game-slide'>
        <div className='game-hero'>
            <div className='game-hero-content'>
                <p className='game-hero-heading'>BLANKOS BLOCK <br/> PARTY</p>
                <p className='game-heading-description'>Action-Adventure | PC | Mobile</p>
            </div>
            <div className='game-hero-decription'>
                <p>Immerse yourself in a neon-soaked <br/> 
                    cyberpunk world, battling rogue AI and <br/>
                    hackers in this action-packed adventure.
                </p>
            </div>
